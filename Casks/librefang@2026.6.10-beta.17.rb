cask "librefang@2026.6.10-beta.17" do
  ...
  name "LibreFang 2026.6.10-beta.17"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.6.10-beta.17)"
