cask "librefang@2026.4.4-beta13" do
  ...
  name "LibreFang 2026.4.4-beta13"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.4.4-beta13)"
