cask "librefang@2026.5.2-beta8" do
  ...
  name "LibreFang 2026.5.2-beta8"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.5.2-beta8)"
