cask "librefang@2026.5.30-beta.15" do
  ...
  name "LibreFang 2026.5.30-beta.15"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.5.30-beta.15)"
