cask "librefang@2026.5.28-beta.14" do
  ...
  name "LibreFang 2026.5.28-beta.14"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.5.28-beta.14)"
