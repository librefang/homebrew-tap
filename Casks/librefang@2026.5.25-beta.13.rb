cask "librefang@2026.5.25-beta.13" do
  ...
  name "LibreFang 2026.5.25-beta.13"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.5.25-beta.13)"
