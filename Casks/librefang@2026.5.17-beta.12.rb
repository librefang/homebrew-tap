cask "librefang@2026.5.17-beta.12" do
  ...
  name "LibreFang 2026.5.17-beta.12"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.5.17-beta.12)"
