cask "librefang@2026.6.11-beta.18" do
  ...
  name "LibreFang 2026.6.11-beta.18"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.6.11-beta.18)"
