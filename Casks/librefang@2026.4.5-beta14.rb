cask "librefang@2026.4.5-beta14" do
  ...
  name "LibreFang 2026.4.5-beta14"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.4.5-beta14)"
