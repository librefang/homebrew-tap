cask "librefang@2026.4.19-beta25" do
  ...
  name "LibreFang 2026.4.19-beta25"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.4.19-beta25)"
