cask "librefang@2026.4.27-beta6" do
  ...
  name "LibreFang 2026.4.27-beta6"
  desc "Community-Maintained Agent Operating System written in Rust (pinned to 2026.4.27-beta6)"
